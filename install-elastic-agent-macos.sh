...
## 
## Developed by Iron Vine Security using code originally from Microsoft:
...
## Copyright (c) 2022 Iron Vine Security. All rights reserved.
## Scripts are not supported under any Iron Vine Security standard support program or service. The scripts are provided AS IS without warranty of any kind.
## Iron Vine Security disclaims all implied warranties including, without limitation, any implied warranties of merchantability or of fitness for a
## particular purpose. The entire risk arising out of the use or performance of the scripts and documentation remains with you. In no event shall
## Iron Vine Security, its authors, or anyone else involved in the creation, production, or delivery of the scripts be liable for any damages whatsoever
## (including, without limitation, damages for loss of business profits, business interruption, loss of business information, or other pecuniary
## loss) arising out of the use of or inability to use the sample scripts or documentation, even if Iron Vine Security has been advised of the possibility
## of such damages.
